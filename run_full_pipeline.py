...
Notes:
  ...
  - Use --skip_dataset, --skip_training, or --skip_evaluation to run partial pipeline
    ...
    train_group.add_argument('--sampler_type', type=str, default='random',
                            choices=['hf_shuffle', 'hf_sequential', 'random_no_fix', 'random', 'balanced', 'feature_balanced', 'hierarchical_balanced'],
                            help='Sampler type: hf_shuffle (HF RandomSampler), '
                                 ...
                                 'hierarchical_balanced (50/50 speed balance + distance round-robin + adaptive oversampling)')
