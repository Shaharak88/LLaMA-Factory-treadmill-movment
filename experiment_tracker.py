...
class ExperimentTracker:
    ...
    CSV_COLUMNS = [
        ...
        'train_edge_width',
        'train_distance',
        'train_center_randomization',
        'train_distance_randomization',
        'train_distance_range',
        'train_stripe_width',
    ...
    def start_experiment(self, args, actual_model_path: str = None) -> int:
        ...
        experiment_data = {
            ...
            'train_distance': getattr(args, 'train_distance', ''),
            'train_center_randomization': getattr(args, 'train_center_randomization', ''),
            'train_distance_randomization': getattr(args, 'train_distance_randomization', ''),
            'train_distance_range': getattr(args, 'train_distance_range', ''),
            ...
            'test_distance': getattr(args, 'test_distance', ''),
            'test_center_randomization': getattr(args, 'test_center_randomization', ''),
            'test_distance_randomization': getattr(args, 'test_distance_randomization', ''),
            'test_distance_range': getattr(args, 'test_distance_range', ''),
