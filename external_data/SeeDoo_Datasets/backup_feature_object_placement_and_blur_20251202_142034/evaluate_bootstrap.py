...
LORA_PATH = r"*\LLaMA-Factory\saves\qwen2vl-treadmill-lora"

MOVING_DIR = r"*\LLaMA-Factory\data\treadmill_videos\Treadmill_moving_test"
STOPPED_DIR = r"*\LLaMA-Factory\data\treadmill_videos\Treadmill_stopped_test"
